#include "ds18b20.h"
//---------------------------------------------------------------------
static const char *TAG = "ds18b20.c";
//---------------------------------------------------------------------
...
//---------------------------------------------------------------------
static void _init_ds(DS18B20_Info * ds18b20_info, const OneWireBus * bus)
{
...
//---------------------------------------------------------------------
static bool _is_init_ds(const DS18B20_Info * ds18b20_info)
{
    bool ok = false;
    if (ds18b20_info != NULL)
    {
...
static DS18B20_ERROR _read_scratchpad(const DS18B20_Info * ds18b20_info, Scratchpad * scratchpad, size_t count)
{
  ...
  count = _min(sizeof(Scratchpad), count);
